...
async function scrape() {
    ...
    const stream = fs.createWriteStream('ios_apps_br_paid.csv', streamOptions) //preparamos um novo arquivo no file server o arquivo para receber o fluxo de dados no formato csv
